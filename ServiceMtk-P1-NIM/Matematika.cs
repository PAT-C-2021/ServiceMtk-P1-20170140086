        ...
        public int Bagi(int a, int b)
        {
            ...
            catch (Exception ex)
            {
              Console.WriteLine(ex.Message);
                ...
                //secara default
                //throw new Exception(ex.Message) // pesan error seacara default
                // throw new FaultException("Pesan Salah"); //untuk meloloskan pesan error yang dikitim ke client

                MathFault mf = new MathFault();
                mf.Kode = "Inputan Yang Anda Masukan Salah";
                mf.Pesan = " Masukan Inputan Yang Benar";
